            ...
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <div><a href="#assess/addsurvey"  class="btn btn-primary btn-xs ">添加</a></div>
                    </div>
                </div>
                    ...
                    <form class="form-horizontal" id="userSearch">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-lg-4 col-md-4 col-xs-4 col-sm-offset-2">
                                ...
                                <button  class="btn btn-white btn-sm" id="clearnBtn" type="button" >清空</button>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="panel-heading">
                            <div class="panel-options">
                                <ul id="orgTab" class="nav nav-tabs">
                                    <li class="active" id="pubTab"><a data-toggle="tab" href="#tab-1">未审核</a>
                                    </li>
                                    <li class="" id="npubTab"><a data-toggle="tab" href="#tab-2">待审核</a>
                                    </li>
...
<script type="text/javascript">
    jQuery(function(){
        ...
        $('#searchBtn').click(function(){
            ...
            }else if($('#npubTab').hasClass('active')){
