                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-lg-8 col-xs-8 col-md-8">
                                <table class="table table-bordered">
                                    <thead>
                                    <tr class="tr-tit">
                                        <th class="text-center" colspan="3">机构名称</th>
                                    </tr>
                                    <tr class="tr-tit">
                                    ...
                                    <c:forEach var="an" items="${command.orgps}">
                                        <tr class="tr-data" data-anid="${an.id}">
                                            <td >
                                                    ${an.name}
                                            </td>
                                            <td >
                                                    <fmt:formatNumber type="number" maxFractionDigits="0" value="${an.total}" />
                                            </td>
                                            <td >
                                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                    <c:if test="${an.total==null}">
                                                        <a class="blue" href="#assess/pjorgsurvey/${command.id}/${an.id}?s=0" data-rel="tooltip" title="考评打分"><i class="fa fa-lg fa-pencil bigger-130"></i></a>
                                                    </c:if>
                                                    <c:if test="${an.total!=null}">
                                                        <a class="blue" href="#assess/rpjorgsurvey/${an.id}/${command.id}?s=0" data-rel="tooltip" title="重新考评"><i class="fa fa-lg fa-edit bigger-130"></i></a>
                                                    </c:if>
                                                </div>
...
<script>
    function surveyspj(){
//        var ss='#assess/pjorgsurvey/'+rec.id+'/'+rec.orgId+'';
    }
</script>
