...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h3>${command.id!=null?"编辑广告":"添加广告"}</h3>
        <ol class="breadcrumb">
            ...
            <li>
                <strong>${command.id!=null?"编辑广告":"添加广告"}</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <div><a href="#advert/index"  class="btn btn-primary btn-xs">返回</a></div>
                    </div>
                </div>
...
<script type="text/javascript" src="<c:url value="/resources/js/model/advert.js"/>"></script>
