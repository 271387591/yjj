            ...
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <div><a href="#dictionary/addDic" class="btn btn-primary btn-xs ${oz:contains(userinfo.features, 'addUser')?'':'hidden'}">添加</a></div>
                    </div>
                </div>
                    ...
                    <form class="form-horizontal" id="userSearch">
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select  id="userSearchSelect" class="form-control" name="user.Q_r.typeId_EQ" data-validate="required">
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="user.Q_r.keyValue_LK" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    initComboData($('#userSearchSelect'),'html/dictionaryType/list',{start:0,limit:200},'id','dtype',null,true);
    jQuery(function(){
        hchosen($('#userSearchSelect'));
        listTable();
    })
