...
public class JsonReaderResponse<T> {
  ...
  public JsonReaderResponse(Collection<T> data, boolean success, int total, String message) {
    ...
    public JsonReaderResponse(Collection<T> data,int total,int page,int limit, String message) {
        this.message = message;
        this.total = total;
        this.data = data;
        this.page=page;
        ...
        this.pages=Double.valueOf(Math.ceil(Double.valueOf(total)/limit)).intValue();
    }
