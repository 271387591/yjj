...
public class WebSecurityExpressionRoot implements MethodSecurityExpressionOperations {
    ...
    public final boolean hasAnyFeature(String... features) {
        ...
        Set<String> ff = user.getFeatures();
        for (String s : features) {
            return ff.contains(s);
        }
        return false;
    }
    ...
    public final boolean hasFeature(String feature) {
        User user = (User) authentication.getPrincipal();
        return user.getFeatures().contains(feature);
    }
